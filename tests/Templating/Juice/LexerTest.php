...
HTML);
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 1, 2, '!DOCTYPE'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Space, 1, 10, ' '), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Name, 1, 11, 'html'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 1, 15, '>'), $lexer->next(Context::HtmlTag));
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 2, 2, 'html'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Space, 2, 6, ' '), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Name, 2, 7, 'lang'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Equals, 2, 11, '='), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::StringDelim, 2, 12, '"'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Name, 2, 13, 'en'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::StringDelim, 2, 15, '"'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 2, 16, '>'), $lexer->next(Context::HtmlTag));
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 3, 2, 'body'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 3, 6, '>'), $lexer->next(Context::HtmlTag));
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 4, 6, 'p'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 4, 7, '>'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::Text, 4, 8, 'foo+bar-baz::foo'), $lexer->next(Context::Html));
        $this->assertEquals(new Token(HtmlTokenKind::EndTagOpen, 4, 24, '</'), $lexer->next(Context::Html));
        $this->assertEquals(new Token(HtmlTokenKind::Name, 4, 26, 'p'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 4, 27, '>'), $lexer->next(Context::HtmlTag));
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 5, 3, 'body'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 5, 7, '>'), $lexer->next(Context::HtmlTag));
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 6, 3, 'html'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 6, 7, '>'), $lexer->next(Context::HtmlTag));
...
HTML);
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 7, 3, 'body'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 7, 7, '>'), $lexer->next(Context::HtmlTag));
        ...
        $this->assertEquals(new Token(HtmlTokenKind::Name, 8, 3, 'html'), $lexer->next(Context::HtmlTag));
        $this->assertEquals(new Token(HtmlTokenKind::TagClose, 8, 7, '>'), $lexer->next(Context::HtmlTag));
