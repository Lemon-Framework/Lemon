...
HTML);
        ...
        $lexer->changeContext(Context::Html);
        $this->assertEquals(new Token(JuiceTokenKind::DirectiveEnd, new Position(4, 31), "]"), $lexer->next());  
        ...
        $lexer->changeContext(Context::Html);
        $this->assertEquals(new Token(JuiceTokenKind::OutputEnd, new Position(5, 24), "]]"), $lexer->next());  
        $lexer->changeContext(Context::Html);
